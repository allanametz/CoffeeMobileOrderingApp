...
import { Container, Content, View, Header, Icon, Button, Left, Right, Body, Title, List, ListItem, Grid, Col, Item } from 'native-base';
      ...
      items.push(
        ...
        >
          <Body style={{paddingLeft: 10}}>
            ...
            {count == this.state.cartItems.length ? <Text style={{ fontSize: 20, fontStyle: 'bold' }}>Total: ${total.toFixed(2)}</Text> : null}
          </Body>
          <Right>
